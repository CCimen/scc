    ...
    return PluginAuditResult(
        ...
        manifests=PluginManifests(
            ...
            hooks=ManifestResult(
                status=ManifestStatus.MISSING, path=Path("hooks/hooks.json")
            ),
        ),
    )
...
class TestAuditPluginsCommand:
    ...
    def test_audit_plugins_shows_header(
        self, sample_audit_output: AuditOutput
    ) -> None:
        """Should display header with plugin count."""
        with patch(
            "scc_cli.cli_audit.audit_all_plugins", return_value=sample_audit_output
        ):
    ...
    def test_audit_plugins_shows_plugin_names(
        self, sample_audit_output: AuditOutput
    ) -> None:
    ...
    def test_audit_plugins_shows_status(
        self, sample_audit_output: AuditOutput
    ) -> None:
    ...
    def test_audit_plugins_shows_mcp_servers(
        self, parsed_plugin: PluginAuditResult
    ) -> None:
    ...
    def test_audit_plugins_shows_malformed_error(
        self, malformed_plugin: PluginAuditResult
    ) -> None:
    ...
    def test_audit_plugins_shows_disclaimer(
        self, sample_audit_output: AuditOutput
    ) -> None:
...
class TestAuditPluginsJsonOutput:
    ...
    def test_json_output_has_summary(
        self, sample_audit_output: AuditOutput
    ) -> None:
    ...
    def test_json_output_has_plugins_array(
        self, sample_audit_output: AuditOutput
    ) -> None:
    ...
    def test_json_output_plugin_structure(
        self, parsed_plugin: PluginAuditResult
    ) -> None:
    ...
    def test_json_output_includes_mcp_servers(
        self, parsed_plugin: PluginAuditResult
    ) -> None:
    ...
    def test_json_output_includes_error_details(
        self, malformed_plugin: PluginAuditResult
    ) -> None:
...
class TestAuditPluginsExitCodes:
    ...
    def test_exit_1_when_malformed(
        self, problematic_audit_output: AuditOutput
    ) -> None:
        """Should exit 1 when any plugin has malformed manifest."""
        with patch(
            "scc_cli.cli_audit.audit_all_plugins", return_value=problematic_audit_output
        ):
            result = runner.invoke(cli.app, ["audit", "plugins"])
...
class TestAuditOutputSecurity:
    ...
    def test_relative_paths_in_output(
        self, parsed_plugin: PluginAuditResult
    ) -> None:
