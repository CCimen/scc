...
class TestDisplayBranch:
    ...
    def test_get_display_branch_only_strips_scc_prefix(self):
        """get_display_branch should not preserve old agent-prefixed branch behavior."""
        assert git.get_display_branch("scc/feature-x") == "feature-x"
        assert git.get_display_branch("claude/feature-y") == "claude/feature-y"
