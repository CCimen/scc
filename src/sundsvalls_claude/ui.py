...
╔═══════════════════════════════════════════════════════════════╗
║   ____                  _               _ _                   ║
║  / ___| _   _ _ __   __| |_____   ____ | | |___               ║
║  \\___ \\| | | | '_ \\ / _` / __\\ \\ / / _` | | / __|              ║
║   ___) | |_| | | | | (_| \\__ \\\\ V / (_| | | \\__ \\              ║
║  |____/ \\__,_|_| |_|\\__,_|___/ \\_/ \\__,_|_|_|___/              ║
║                                                               ║
...
def select_team(console: Console, cfg: dict) -> Optional[str]:
...
def select_workspace_source(console: Console, cfg: dict, team: str) -> str:
    ...
    table.add_row(f"[0]", "❌ Cancel", "Exit without starting")
...
def select_recent_workspace(console: Console, cfg: dict) -> Optional[str]:
...
def select_team_repo(console: Console, cfg: dict, team: str) -> Optional[str]:
...
def prompt_custom_workspace(console: Console) -> Optional[str]:
...
def show_worktree_options(console: Console, workspace: Path) -> Optional[str]:
